...
# 边界框删选
# proposal_count: 选取多少个边界框
# nms_threshold: nms的阈值
# inputs[0]为rpn_probs, inputs[1]为rpn_bbox
# rpn_bbox是为了对框进行微调
# anchors对应框的坐标
def proposal_layer(inputs, proposal_count, nms_threshold, anchors, config=None):
    ...
    # 从原来的 [batch_size, ..] -> [...], 因为batch_size为1
    '''
    >>> x = np.array([[[0], [1], [2]]])
    >>> x.shape
    (1, 3, 1)
...
class RPN(nn.Module):
    ...
    def forward(self, x):
        ...
        # Reshape to [batch, height, width, anchors_per_location * 2].
